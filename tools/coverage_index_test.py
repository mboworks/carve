...
class CoverageIndexTest(unittest.TestCase):
    ...
    def test_report_contains_policy_table_and_lcov_link(self):
        ...
        self.assertIn("carve coverage: pr/42", rendered)
    ...
    def test_site_interleaves_prs_and_releases_by_main_history(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertIn(
                'href="https://github.com/mboworks/carve/releases/tag/v0.10.0">release v0.10.0</a>',
                rendered,
            )
            self.assertIn('href="https://github.com/mboworks/carve/pull/42">PR #42</a>', rendered)
            self.assertIn('href="pr/42/coverage-summary.json">JSON</a>', rendered)
            self.assertIn("2026-08-22 10:01:00 UTC", rendered)
            self.assertIn('href="https://github.com/mboworks/carve/commit/abc"><code>abc</code></a>', rendered)
            self.assertIn('href="https://github.com/mboworks/carve/actions/runs/1">run 1</a>', rendered)
    ...
    def test_legacy_report_does_not_link_placeholder_metadata(self):
        ...
        self.assertIn('href="https://github.com/mboworks/carve/pull/9">PR #9</a>', row)
