...
Project rule (``STYLE_CPP.md``): all exported code is tested at the appropriate level.
This check makes the package-local unit-test part of that rule mechanical.
...
_ALLOWLIST: dict[str, str] = {
    "rules/testdata:lib_cc": (
        "synthetic aspect-analysis fixture exercised by //rules:carve_test; keeping it in a separate package "
        "is the behavior under test"
    ),
    "rules/testdata:lib_with_external_dep_cc": (
        "synthetic aspect-analysis fixture exercised by //rules:carve_test; keeping it in a separate package "
        "is the behavior under test"
    ),
}
