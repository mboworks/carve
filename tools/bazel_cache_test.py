...
class BazelCacheTest(unittest.TestCase):
    ...
    def test_workflows_refresh_only_main_and_release_only_restores(self):
        ...
        self.assertEqual(workflow.count("uses: ./.github/actions/bazel-cache-restore"), 6)
        self.assertEqual(workflow.count("uses: ./.github/actions/bazel-cache-save"), 6)
        self.assertEqual(workflow.count("!cancelled() && github.ref == 'refs/heads/main'"), 6)
